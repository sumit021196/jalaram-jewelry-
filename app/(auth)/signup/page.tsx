            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-sm text-gray-500 max-w-[240px] mx-auto leading-relaxed">
                        Join {settings.site_name || "us"} for a curated luxury experience.
                    </p>
                </div>
                ...
                <form action={handleSubmit} className="space-y-4">
                    ...
                    <div className="pt-4 text-center">
                        <p className="text-[13px] text-gray-500 font-medium">
                            ...
                            <Link href="/login" className="text-black font-black hover:underline underline-offset-4 decoration-2 transition-all">
                                Log in
                            </Link>
                        </p>
                    </div>
